    ...
    <div class="w-full max-w-md">
        ...
        <div class="bg-white dark:bg-[#161615] p-8 rounded-lg shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d]">
            ...
            <form method="POST" action="{{ route('register') }}" class="space-y-4">
                ...
                <button 
                    type="submit" 
                    class="w-full dark:bg-[#eeeeec] dark:border-[#eeeeec] dark:text-[#1C1C1A] dark:hover:bg-white dark:hover:border-white hover:bg-black hover:border-black px-5 py-2 bg-[  dark:hover:bg-white dark:hover:border-white hover:bg-black hover:border-black px-5 py-2 bg-[#1b1b18] rounded-sm border border-black text-white text-sm"
                >
                    Registrarse
                </button>
            </form>
